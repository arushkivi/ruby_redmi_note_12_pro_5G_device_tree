...
# Kernel Parameters
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.init_fatal_reboot_target=bootloader buildvariant=eng
...
BOARD_DTBOIMG_PARTITION_SIZE := 69697536
...
BOARD_MIUI_DYNAMIC_PARTITIONS_SIZE := 9122611200 # Actual super partition size minus overhead
